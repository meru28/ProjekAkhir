        ...
        if(this.state.selectedEdit === item.id){
            return (
                <tr>
                    ...
                    <td><input ref="descEdit" type="text" defaultValue={item.description}/></td>
                    <td><input className="btn btn-primary" type="button" value="Save" onClick={() => this.onBtnSaveClick(item.id)}/></td>
                    <td><input className="btn btn-danger" type="button" value="Cancel" onClick={() => this.setState({selectedEdit: 0})}/></td>
                </tr>
            )   
        } 
            return (
                <tr>
                    ...
                    <td><input className="btn btn-danger" type="button" value="Delete" onClick={() => this.onBtnDelClick(item.id)}/></td>
                </tr>
            )
        ...
        return(
            ...
            <table className="asp.ex1">
                ...
                <tfoot>
                    ...
                    <td>
                        <textarea ref="descAdd" type="text" placeholder="Enter the Description here"></textarea> />
                    </td>
                    <td>
